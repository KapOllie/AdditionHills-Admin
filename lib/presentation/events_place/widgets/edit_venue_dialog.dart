                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                            child: InkWell(
                          onTap: () {
                            List allEventRequirements = List.generate(
                                listControllers.length,
                                (index) => listControllers[index].text);
                            List allAvailableDays = List.generate(
                                availableDays.length,
                                (index) =>
                                    "${availableDays[index].text}:${timeFromList[index].text} - ${timeUntilList[index].text}");
                            if (_formKey.currentState!.validate()) {
                              EventVenue newEventVenue = EventVenue(
                                  ...
                                  venuePrice: newPriceCtrl.text,
                                  venueAvailable: allAvailableDays,
                                  createdOn: Timestamp.now(),
                                  lastUpdatedOn: Timestamp.now());

                              _databaseService.addVenue(newEventVenue);
                              newEventName.clear();
