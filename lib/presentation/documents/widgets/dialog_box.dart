...
class DialogBox {
  ...
  showViewDialogBox(BuildContext context, Document viewDocument) {
    List<dynamic> viewDocRequirements = viewDocument.docRequirements == []
        ? [TextEditingController()]
        : List.generate(viewDocument.docRequirements.length,
    ...
    TextEditingController viewPrice =
        TextEditingController(text: viewDocument.fee.toString());
  ...
  showUpdateDialogBox(
    ...
    List<TextEditingController> updateDocReq =
        updateDocument.docRequirements.isEmpty
            ? [TextEditingController()]
            : List.generate(
                updateDocument.docRequirements.length,
                (index) => TextEditingController(
                    text: updateDocument.docRequirements[index]));

    bool hasReq = updateDocument.docRequirements.isEmpty ? false : true;

    TextEditingController _priceController =
        TextEditingController(text: updateDocument.fee.toString());
